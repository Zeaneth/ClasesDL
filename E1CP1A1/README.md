...
~~~
<!-- la etiqueta <head> está mal ubicada, debe estar después de html y antes de body.
	así:
<!DOCTYPE html>
<!DOCTYPE html>
<html>
...
~~~
<!-- le falta agregar <meta charset="utf-8"> dentro de <head> </head>-->
...
~~~
<!-- falta la etiqueta <title></title> entre los <head></head>-->
...
~~~
<!-- <h1></h1> debiese ser hijo de <body></body> -->
...
~~~
<!--Porque deben estar anidados en 2 distintos <p></p> -->
##Ejercicio 7:
...
~~~
<!-- la sintaxis del párrafo es <p> P&aacuterrafo 1 </p> (porque no tiene el meta con uft-8) -->
##Ejercicio 8:
...
<!-- las etiquetas <p></p> deben estar anidadas en el <body></body> -->
...
~~~
<!--después del href debe venir la URL <a href="link"> Soy un link </a> -->
...
~~~
<!-- debiese ser <p style="color: red;"></p> -->
...
~~~
<!-- debe ser <p style="color: red"></p>, con cierre de comillas -->
...
~~~
<!-- alt debiese ser src, así <img src="logo.png"> -->
...
<body>
	...
	<a href="www.desafiolatam.com" target="_blank">link a Desafío Latam!</a>
	<img href="www.google.cl" src="../logo.png">

</body>
</html>
~~~

<!-- al href le falta target="_blank".  y dentro de la imagen va href en vez de alt-->
